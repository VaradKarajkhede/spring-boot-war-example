    ...
    stages {
        ...
        stage("Deploy on Test"){
            steps{
                ...
                deploy adapters: [tomcat9(credentialsId: 'tomcatserverdetails', path: '', url: 'http://3.82.25.73:8080')], contextPath: '/app', war: '**/*.war'
        ...
        stage("Deploy on Prod"){
            ...
            steps{
                // deploy on container -> plugin
                deploy adapters: [tomcat9(credentialsId: 'tomcatserverdetails', path: '', url: 'http://3.82.25.73:8080')], contextPath: '/app2', war: '**/*.war'
